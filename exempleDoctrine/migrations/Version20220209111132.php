 ...
 */
final class Version20220209111132 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE products DROP supplier_id_id, CHANGE product_name product_name VARCHAR(40) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE quantity_per_unit quantity_per_unit VARCHAR(20) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
